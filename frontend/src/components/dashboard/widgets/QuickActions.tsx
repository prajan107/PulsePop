    ...
    <Card className="border-[#1F2937] bg-[#111827]/80 backdrop-blur-xl">
      ...
      <CardContent className="p-4 space-y-2.5 text-xs">
        {onRefresh && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-[10px] text-[#64748B]">Fetch latest backend dataset</p>
            </div>
          </button>
        )}
        ...
        >
          ...
          <div>
            <p className="font-semibold">Browse Trends</p>
            <p className="text-[10px] text-[#64748B]">Explore real-time signal stream</p>
          </div>
        </Link>
        ...
        >
          ...
          <div>
            ...
            <p className="text-[10px] text-[#64748B]">View active session details</p>
          </div>
        </Link>
      </CardContent>
    </Card>
